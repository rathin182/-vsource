...
const TABS: TabConfig[] = [
  {
    key: "countries",
    label: "Countries",
    endpoint: "/api/countries/all?all=true",
  ...
  },
  {
    key: "intake",
    label: "Intake",
    endpoint: "/api/intakes/all?all=true",
  ...
  },
  {
    key: "lead-source",
    label: "Lead Source",
    endpoint: "/api/lead-sources?all=true",
  ...
  },
  {
    key: "lead-degree",
    label: "Lead Degree",
    endpoint: "/api/lead-degrees?all=true",
  ...
  },
  {
    ...
    endpoint: "/api/lead-universities?all=true",
